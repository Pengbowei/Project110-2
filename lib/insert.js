...
module.exports = insert = async(_id) =>{
    try{
        ...
        for (let index = 0; index < 24; index++) {
            ...
            var event = new Date(ohlcv[index][0])
            client.query("INSERT INTO timeframe_1h(symbol, date, start_time, open, high, low, close, volumn) VALUES($1::varchar,$2::smallint, $3::varchar, $4::decimal, $5::decimal, $6::decimal, $7::decimal, $8::decimal)", [_id, event.getDate(), event.toLocaleTimeString(), ohlcv[index][1], ohlcv[index][2], ohlcv[index][3], ohlcv[index][4], ohlcv[index][5]])
